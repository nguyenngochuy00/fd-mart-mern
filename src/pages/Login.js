            ...
            <Container style={{ minHeight: "95vh", paddingTop: '10px' }}>
                <Row>
                    <Col md={6} className="login__form--container">
                        <h2 className="text-center" style={{ color: "#008c7a", textTransform: "uppercase", paddingBottom: "10px" }}>Đăng nhập</h2>
                        {isError && <Alert variant="danger">{error.data}</Alert>}
                        <Form style={{ width: "100%", background: "#F9F8F4", borderRadius: "20px" }} onSubmit={handleLogin} >
                    ...
                    <Col md={6} className="login__image--container" style={{ borderRadius: '20px' }}></Col>
                </Row>
